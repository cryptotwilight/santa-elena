...
interface ISEAuditContract {
    ...
    enum AUDIT_STATE{READY, BOOKED_FOR_AUDIT, AUDIT_COMPLETE, PUBLIC, WITHDRAWN}
     ...
     * @param _declaration declaration as to whether or not the data presented is satisfactory or not
