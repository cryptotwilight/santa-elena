...
/**
 * @title ISERegistryLite 
 * @dev the ISEREgistryLite interface creates a registry for all contracts related to Santa Elena. It's purpose is to make the look up 
 * of stable contract versions and autoconfiguration easier, saving development time. 
 */
interface ISERegistryLite { 
